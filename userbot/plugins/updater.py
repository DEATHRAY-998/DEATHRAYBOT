...
UPSTREAM_REPO_URL = "https://github.com/DEATHRAY-998/DEATHRAYBOT"
...
async def upstream(ups):
    ...
    try:
        ...
        if conf != "now":
            await ups.edit(f"Hey, did you type update🤔.....Okay..My PRO sweet master..🤗\
            \nPlease do type |.update now| to update your DeathRay😎.")
            return
        repo = Repo.init()
